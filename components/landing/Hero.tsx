...
export default function Hero({
  ...
  return (
    <section className="relative overflow-hidden border-b border-white/10">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(190,242,100,0.16),transparent_42%)]" />
        ...
        <div className="max-w-3xl">
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            ...
            <a
              ...
              className="rounded-xl border border-white/20 px-8 py-4 font-semibold transition hover:border-[#bef264] hover:text-[#bef264]"
            >
